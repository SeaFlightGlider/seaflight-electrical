...
F 2 "Connector_PinHeader_2.54mm:CUI_TBP01R1W-508-16BE" H 992 1943 50  0000 C CNN
...
U 1 1 60C75C8C
P 1000 2450
F 0 "J12" H 1050 2767 50  0000 C CNN
F 1 "Steering Turbines" H 1050 2676 50  0000 C CNN
F 2 "TerminalBlock_CUI:CUI_TBP01R1W-508-08BE" H 1000 2450 50  0001 C CNN
F 3 "~" H 1000 2450 50  0001 C CNN
	1    1000 2450
	1    0    0    -1  
$EndComp
Text Label 150  2350 0    50   ~ 0
turbine1_wht
Text Label 150  2450 0    50   ~ 0
turbine1_grn
Text Label 150  2550 0    50   ~ 0
turbine1_blu
...
F 1 "Pump Current Sensor" H 6628 1335 50  0000 L CNN
...
F 2 "TerminalBlock_CUI:CUI_TBP01R1W-508-12BE" H 6200 2700 50  0001 C CNN
...
F 2 "TerminalBlock_CUI:CUI_TBP01R1W-508-08BE" H 6250 3650 50  0001 C CNN
...
U 1 1 60F0762C
P 650 3050
F 0 "#PWR0147" H 650 2900 50  0001 C CNN
...
U 1 1 60F07632
P 650 3150
F 0 "#PWR0148" H 650 2900 50  0001 C CNN
...
U 1 1 60F07638
P 1600 3050
F 0 "J45" H 1628 3026 50  0000 L CNN
F 1 "Engine Current Sensor" H 1628 2935 50  0000 L CNN
F 2 "Connector_Molex:Molex_KK-254_AE-6410-06A_1x06_P2.54mm_Vertical" H 1600 3050 50  0001 C CNN
...
U 1 1 611A3BDB
P 8350 3300
F 0 "J2" H 8378 3276 50  0000 L CNN
F 1 "Power Rail" H 8378 3185 50  0000 L CNN
F 2 "Connector_Molex:Molex_KK-254_AE-6410-08A_1x08_P2.54mm_Vertical" H 8350 3300 50  0001 C CNN
...
U 1 1 611D7AFE
P 7600 3700
F 0 "#PWR0165" H 7600 3550 50  0001 C CNN
F 1 "-BATT" H 7615 3873 50  0000 C CNN
...
U 1 1 61224084
P 8150 3000
F 0 "#PWR0166" H 8150 2850 50  0001 C CNN
...
U 1 1 6123DB4E
P 7550 3100
F 0 "#PWR0167" H 7550 2850 50  0001 C CNN
...
F 1 "Reservoir Pressure Sensor" H 10150 426 50  0000 C CNN
...
U 1 1 619ADBCA
P 7850 3000
F 0 "#PWR0171" H 7850 2850 50  0001 C CNN
